...
<header role="banner">
	...
	<div class="container-fluid asu-menu d-lg-none">
			<div id="mobile-nav-header" class="navbar-header">
				<a class="navbar-brand asu-menu" href="https://data.sustainability.asu.edu/caplter-portal/home.jsp">Data Portal</a>
			</div>
	</div>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item home-icon">
							<a class="nav-link" href="https://sustainability.asu.edu/caplter"><span class="fas fa-home"></span></a>
                        </li>
						<li class="nav-item">
							<a class="nav-link" href="https://sustainability.asu.edu/caplter/people/">People</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="https://sustainability.asu.edu/caplter/research/">Research</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="https://sustainability.asu.edu/caplter/education/">Education</a>
                        </li>
                        <li class="nav-item">
							<a class="nav-link" href="https://sustainability.asu.edu/caplter/collaborations/">Collaboration</a>
						</li>
                        <li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link" href="https://sustainability.asu.edu/caplter/news/">News</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="https://sustainability.asu.edu/caplter/about/">About</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="https://sustainability.asu.edu/caplter/contact/">Contact</a>
						</li>
				</div>
			</nav>
		</div>
